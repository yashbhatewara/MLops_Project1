    ...
    def create_folder(self, folder_name: str, bucket_name: str) -> None:
        ...
        try:
            ...
            if e.response["Error"]["Code"] == "404":
                ...
                self.s3_client.put_object(Bucket=bucket_name, Key=folder_obj,Body=b"",ServerSideEncryption="AES256")
    ...
    def upload_file(self, from_filename: str, to_filename: str, bucket_name: str, remove: bool = True):
        ...
        try:
            ...
            with open(from_filename, "rb") as file:
                self.s3_client.put_object(Bucket=bucket_name, Key=to_filename,Body=file,ServerSideEncryption="AES256")
